...
public class LerFicheiroEventoXML implements LerFicheiroEvento{
    ...
    @Override
    public void LerFicheiro(String nomeFicheiro, Empresa empresa) throws ParserConfigurationException, SAXException, IOException {
     ...
     //   try {
            ...
            for (int s = 0; s < listaEventos.getLength(); s++) {
                ...
                if (eventoNode.getNodeType() == Node.ELEMENT_NODE) {
                    ...
                    empresa.getM_registoEventos().novoEvento();
                    String nome="";
