...
public class CriarCPController {
    ...
    public List<Evento> getEventosOrganizador(String strId) {
        return this.m_empresa.getEventosOrganizador(strId);
    }
    ...
    public Revisor addMembroCP(String strId) {
        Utilizador u = this.m_empresa.getUtilizador(strId);
    ...
    /**
     * Regista na lista de membros da CP (Comissão de Programa) o Revisor passado por parâmetro.
     *
    ...
    /**
     * Atribui lista de tópicos de perícia a Revisor da CP (Comissão de Programa).
     *
